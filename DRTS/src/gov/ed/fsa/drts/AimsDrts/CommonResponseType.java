...
public class CommonResponseType  implements java.io.Serializable {
    private gov.ed.fsa.drts.AimsDrts.StatusCodeType statusCode;

    private gov.ed.fsa.drts.AimsDrts.ReasonCodeType reasonCode;
    ...
    public CommonResponseType(
           gov.ed.fsa.drts.AimsDrts.StatusCodeType statusCode,
           gov.ed.fsa.drts.AimsDrts.ReasonCodeType reasonCode,
           java.lang.String reasonCodeDescription) {
     ...
     * @return statusCode
     */
    public gov.ed.fsa.drts.AimsDrts.StatusCodeType getStatusCode() {
        return statusCode;
    }
     ...
     * @param statusCode
     */
    public void setStatusCode(gov.ed.fsa.drts.AimsDrts.StatusCodeType statusCode) {
        this.statusCode = statusCode;
    }
     ...
     * @return reasonCode
     */
    public gov.ed.fsa.drts.AimsDrts.ReasonCodeType getReasonCode() {
        return reasonCode;
    }
     ...
     * @param reasonCode
     */
    public void setReasonCode(gov.ed.fsa.drts.AimsDrts.ReasonCodeType reasonCode) {
        this.reasonCode = reasonCode;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CommonResponseType)) return false;
