...
public class AimsDrtsService_ServiceLocator extends org.apache.axis.client.Service
		implements gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsService_Service {
	...
	public AimsDrtsService_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	@Override
	public gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsService_PortType getAimsDrtsServiceSOAP()
			throws javax.xml.rpc.ServiceException {
	...
	@Override
	public gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsService_PortType getAimsDrtsServiceSOAP(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsServiceSOAPStub _stub =
					new gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsServiceSOAPStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsService_PortType.class
					.isAssignableFrom(serviceEndpointInterface)) {
				gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsServiceSOAPStub _stub =
						new gov.ed.fsa.drts.AimsDrtsServicex.AimsDrtsServiceSOAPStub(
								new java.net.URL(AimsDrtsServiceSOAP_address), this);
				_stub.setPortName(getAimsDrtsServiceSOAPWSDDServiceName());
				return _stub;
			}
