...
public class DeleteAccountRequestType implements java.io.Serializable {
	...
	public DeleteAccountRequestType(java.lang.String userId) {
		this.userId = userId;
	}

	/**
	 * Gets the userId value for this DeleteAccountRequestType.
	 * 
	 * @return userId
	 */
	...
	/**
	 * Sets the userId value for this DeleteAccountRequestType.
	 * 
	 * @param userId
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DeleteAccountRequestType))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.userId == null && other.getUserId() == null)
