...
public class Report2OpenClosed extends PageUtil implements Serializable {
	...
	public void init()
	{
		...
		try
		{
			report_rows_from_db = DataLayer.getInstance().getOpenClosedReqReport();
			...
			for(int i = 0; i < 30; i++)
			{
				...
				{
					System.out.println("comparing: " + today.toString() + " to " + report_rows_from_db.get(j).getReportDate().toString());
