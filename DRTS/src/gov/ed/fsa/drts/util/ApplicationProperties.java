...
public enum ApplicationProperties {
	...
	DATA_REQUEST_FIELD_DELAY_REASON(true, false),

	DATA_REQUEST_FIELD_ORIGINAL_REQUEST_DATE(true, false),

	DATA_REQUEST_FIELD_AGREED_DUE_DATE(true, false),

	DATA_REQUEST_FIELD_ANTICIPATED_DUE_DATE(true, false),

	DATA_REQUEST_FIELD_DATE_RUN(true, false),

	DATA_REQUEST_FIELD_REPORT_TYPE(true, false),

	DATA_REQUEST_FIELD_QUERY_REPORT_NAME(true, false),

	DATA_REQUEST_FIELD_CLARIFICATIONS_ASSUMPTIONS(true, false),

	DATA_REQUEST_FIELD_DETAILED_STEPS(true, false),

	DATA_REQUEST_FIELD_VALIDATION_DESCRIPTION(true, false),

	DATA_REQUEST_FIELD_VALIDATION_RESULT(true, false),

	DATA_REQUEST_FIELD_GOLDEN_QUERY_LIBRARY(true, false),

	DATA_REQUEST_FIELD_BUSINESS_REQUIREMENTS(true, false),

	DATA_REQUEST_FIELD_TIER(true, false),

	DATA_REQUEST_FIELD_SME_GROUP(true, false),
	...
	DATA_REQUEST_WORKFLOW_REQUEST_DRAFTED_SUBMITTED(true, false),
	...
	DATA_REQUEST_DELAY_REASONS(true, true),

	DATA_REQUEST_REPORT_TYPES(true, true),

	DATA_REQUEST_SME_GROUPS(true, true),
		...
		if (string_value == null) {
			...
			if (required) {
				throw new MissingResourceException(
						"Property '" + toString() + "' not found in resource bundle '"
								+ ApplicationProperties.PROPERTIES_FILE_NAME + "', required",
						ApplicationProperties.PROPERTIES_FILE_NAME, toString());
			}
		} else {
