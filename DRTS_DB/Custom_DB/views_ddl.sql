...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "OPEN_CLOSED_REQUESTS" ("DATE_DAY", "OPENED_REQS", "CLOSED_REQS") AS SELECT 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "SME_ASSIGNED_REPORT" ("SME", "SMECNT", "VALSMECNT") AS select (CASE WHEN as1 IS NULL THEN as2 ELSE as1 END) as SME, coalesce(SMECNT,0) as SMECNT, coalesce(VALSMECNT,0) as VALSMECNT from (
